// ✅ CHANGED: Switched from 'puppeteer-core' to standard 'puppeteer'
...
const generateInvoiceBuffer = async (data) => {
    ...
    // ✅ CHANGED: Removed the strict executablePath to allow Puppeteer to use its own downloaded Chromium
